...
export default function IndexPage() {
  return (
    <>
      ...
      <MainLayout
        style={{
          backgroundImage: "url(/screenshots/board.png)",
      ...
      >
        <Container component="span" style={{ maxWidth: 800, margin: 30, height: "100%" }}>
          ...
          <Title order={2} size={32}>
            S naší platformou si procvičíš logiku, strategii a taktické myšlení, ať už jsi úplný začátečník nebo zkušený hráč. Připrav se na výzvu a
            ukaž, co v tobě je!
          </Title>
