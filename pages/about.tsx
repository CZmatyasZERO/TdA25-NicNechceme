      ...
      <MainLayout>
        <Container style={{ maxWidth: 800, margin: "0 auto", padding: "20px" }}>
          ...
          <Text size="md" style={{ marginTop: "20px" }}>
            Think different Academy je tým nadšených profesionálů zaměřených na rozvoj logického a taktické myšlení. Naši platformu využívají studenti
            a hráči z celého světa pro zlepšování svých dovedností v oblasti strategie a plánování.
          </Text>
          <Title order={2} style={{ marginTop: "40px" }}>
            Kontaktujte nás
          </Title>
          <form onSubmit={form.onSubmit((values) => handleSubmit(values))} style={{ marginTop: "20px" }}>
            <Flex direction="column" gap="md">
              <TextInput label="Jméno" placeholder="Vaše jméno" required {...form.getInputProps("name")} />
              <TextInput label="Email" placeholder="Vaše emailová adresa" required {...form.getInputProps("email")} />
              <Textarea label="Zpráva" placeholder="Vaše zpráva" required {...form.getInputProps("message")} />
              <Group>
