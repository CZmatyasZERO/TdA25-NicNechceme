import { Group, Title, Center, Flex, Container, Button, Select, TextInput, Paper, Pagination, Text, Stack } from "@mantine/core"
          ...
          <Flex wrap="wrap" justify="space-around" align="center" gap="lg" style={{ width: "100%" }}>
            {displayedGames ? (
              displayedGames.map((game) => {
                return (
                  <Paper key={game.uuid} shadow="xs" radius="md" style={{ width: "32%", minWidth: "300px", padding: "5px" }}>
                    <Flex wrap="wrap" justify="center">
                      ...
                      <Stack style={{ width: "300px", padding: "5px" }}>
                        <Title order={3} style={{ textOverflow: "ellipsis" }}>
                          {game.name}
                        </Title>
                        <Group>
                        ...
                        <Link href={"/game/" + game.uuid}>
                          <Button fullWidth>Spustit</Button>
                        </Link>
                      </Stack>
                    </Flex>
                  </Paper>
